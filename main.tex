...
\author{Siem de Jong\footnote{Altough these solution were written with care, I could've made mistakes. If you find one, please let me know.} \\ \url{siem.dejong@student.uva.nl}}
...
\begin{questions}
  ...
  \begin{parts}
    ...
    \begin{solution}
      ...
      \end{displaymath}
      where $m \in \mathbb{Z}$ and $d$ the slitwidth.
